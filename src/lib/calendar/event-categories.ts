...
export const CALENDAR_EVENT_CATEGORIES = Object.keys(CATEGORY_COLORS) as string[]

export function defaultCalendarEventCategory(): string {
  return 'Académico'
}
...
export function modalityOptionsFromEvents(rows: readonly AcademicCalendarEventRecord[]): string[] {
